...
<h1 class="text-center mt-3"> سند التالف  </h1>
...
$searchinput = $_POST['searchinput'];
	...
	$sql='SELECT * FROM s_input WHERE page_number_store_log ='.$searchinput;
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" >
	...
	<div class="col"><p>  العدد </p>  <input required  type="text" name="count"  class="w-50" value="" ></div>
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" > 
	...
	<div class="col"><p> الصفحة  </p>  <input required  type="text" name="page" class="w-50" value="" ></div>
	<div class="col"><p>  جهه الاستهلاك   </p>  <input required  type="text" name="consumption"  class="w-50" value=""></div>
	<div class="col"><p>  التسلل </p>  <input required  type="text" name="sequence"  class="w-50" value=""></div>


	<div class="col-12 text-center mt-5">
		<button class="btn btn-success w-25 " name="add"> أضافة </button>
	</div>
...
$SearchInDataBaseByName = $_POST['name'];

	$sql= "SELECT * FROM stationery WHERE name LIKE '%".$SearchInDataBaseByName."%' 
           UNION
          SELECT * FROM materials WHERE name LIKE '%".$SearchInDataBaseByName."%'";
        ...
        // echo "YESS I FOUND THIS ".$row['name'];
...
// UPDATE materials SET name = 'xxxx' WHERE name LIKE
		$sql2 = "INSERT INTO `damaged`(`name`,`sequence`, `count`, `consumption`, `page`, `date`) VALUES ('".$name."','".$sequence."','".$count."','".$consumption."','".$page."','".$date."')";
		...
		echo "<div class='alert alert-success text-center font-weight-bold'> تم الاضافه بنجاح </div>" ;
			...
			$sql2= "UPDATE stationery  SET number_input = number_input - ".$count." WHERE name LIKE '%".$SearchInDataBaseByName."%'" ;

		$sql2= "UPDATE materials  SET number_input = number_input - ".$count." WHERE name LIKE '%".$SearchInDataBaseByName."%'";
