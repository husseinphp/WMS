...
<h1 class="text-center mt-3">  مواد اخرى  </h1>
...
// echo "searchingsearchingsearching";
...
$searchinput = $_POST['searchinput'];
	...
	$sql='SELECT * FROM stationery WHERE page_number_store_log ='.$searchinput;
...
<!-- <form action="stationery.php" method="post">
	...
	<button class="btn btn-primary" name="searchbtn"> بحث    </button> <input required  type="" name="searchinput" class="w-25 bg-white" placeholder="رقم الصفحة في سجل المخزن">
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" >
	<div class="col"><p> التسلسل </p>  <input required  type="text" name="sequence"  class="w-50" value=""></div>
	<div class="col"><p>    السعر المفرد </p>  <input required  type="text" name="price_singular"  class="w-50" value="" ></div>
	<div class="col"><p>   ،السعر الكلي</p>  <input required  type="text" name="price_total"  class="w-50" value="" ></div>
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" > 
	...
	<div class="col"><p>   ،العدد/واردة</p>  <input required  type="text" name="number_input" class="w-50" value=" " ></div>
	<div class="col"><p>  ،العدد /خارج </p>  <input required  type="text" name="number_out"  class="w-50" value=""></div>
	<div class="col"><p>   ،العدد/رصيد</p>  <input required  type="text" name="number_balance"  class="w-50" value=""></div>
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" > 
	...
	<div class="col"><p>   جهة الشراء</p>  <input required  type="text" name="buyer" class="w-50" value="" ></div>
	<div class="col"><p>  تسلسل السجل العام</p>  <input required  type="text" name="general_record_sequence"  class="w-50" value=""></div>
	<div class="col"><p>   رقم المستند المجهز به المادة</p>  <input required  type="text" name="number_of_the_completed_document"  class="w-50" value=""></div>
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" > 
	...
	<div class="col"><p>  ،الملاحظات</p>  <input required  type="text" name="notes" class="w-50" value="" ></div>
	<div class="col"><p>  ،التاريخ</p>  <input required  type="date" name="date"  class="w-50" value=""></div>
...
<!-- <form action="stationery.php?do=searching" method="post">

	<button class="btn btn-primary" name="searchbtn"> بحث    </button> <input required  type="" name="searchinput" class="w-25 bg-white" placeholder=" أسم المادة">
...
<div class="row text-center mt-5 mb-5" dir="rtl" lang="ar" >
	<div class="col"><p>  أسم المادة </p>  <input required  type="text" name="name"  class="w-50" value=""></div>
	<div class="col"><p> التسلسل </p>  <input required  type="text" name="sequence"  class="w-50" value=""></div>
	<div class="col"><p>    السعر المفرد </p>  <input required  type="text" name="price_singular"  class="w-50" value="" ></div>
	<div class="col"><p>   ،السعر الكلي</p>  <input required  type="text" name="price_total"  class="w-50" value="" ></div>
...
<div class="row">
	<div class="col text-center">
		<button class="btn btn-success w-25 mb-4" name="add"> أضافه</button>
	</div>
...
$SqlStationery = "SELECT  `id` FROM stationery ORDER BY `stationery`.`id` DESC LIMIT 0,1";

   $resStationery=$con->query($SqlStationery);

   $rowSqlStationery=$resStationery->fetch_assoc();
   // echo $rowSqlStationery["id"];
 $randID = rand($rowSqlStationery["id"] * 39 , 851500);
...
$number_out = $_POST['number_out'];
$number_balance = $_POST['number_balance'];
$buyer = $_POST['buyer'];
$general_record_sequence = $_POST['general_record_sequence'];
$number_of_the_completed_document = $_POST['number_of_the_completed_document'];
$notes = $_POST['notes'];


 $sql2 = "INSERT INTO `materials`(`id`,`name`,`sequence`, `price_singular`, `price_total`, `number_input`, `number_out`, `number_balance`, `buyer`, `general_record_sequence`, `number_of_the_completed_document`, `date`, `notes`) VALUES ('".$randID."','".$name."','".$sequence."','".$price_singular."','".$price_total."','".$number_input."','".$number_out."','".$number_balance."','".$buyer."','".$general_record_sequence."','".$number_of_the_completed_document."','".$date."','".$notes."')";
 $query = mysqli_query($con,$sql2);

echo "<div class='alert alert-success text-center font-weight-bold'> تم الاضافه بنجاح </div>" ;
...
include 'tempalte/footer.php';
 ...
 ?>
	...
	<!-- <div class="col"><p>  </p>  <input required  type="text" name=""></div> -->
