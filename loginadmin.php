...
<div class="full-admin h- w-">
<div class="adminpage ">

<div class="row">
<div class="col">

<h1 class="h1 text-center mt-5 text-white" style="font-size: 45px; ">
نظام إدارة المخزن الالكتروني
</h1>

</div>

</div>
	<div class="login text-center " style="top: 10% !important;">
	
		<h1 class="font-weight-bold text-danger " style="font-size: 70px; "><i><?xml version="1.0" encoding="iso-8859-1"?>
<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg version="1.1" id="Layer_1" width="130" class="mb-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
		...
		<h1 class="mb-4 mt-3 h4">تسجيل الدخول </h1>
	        ...
	        <button type="submit" name="loginadmin" class="btn btn-danger btn-block btn-large mt-2" style="background-color: #f0353d;">تسجيل</button>
	        <p class="mt-4 text-light  p-anm" style="display: none"><i class="fas fa-redo-alt mr-4 anm" ></i>جار التحقق</p>
	        <p class="mt-4 text-light text-show " style="display: none">أسم المستخدم أو كلمة السر غير صحيحه </p>
	</div>
</div>
</div>
</form>
